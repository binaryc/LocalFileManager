...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window = [[LongPressGestureHandlerWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
    ...
    self.window.longPressDelegate = [KeyWindowGestureHandler getInstance];
